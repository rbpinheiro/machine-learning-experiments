...
var run = function run() {
  var nodes = new _NodeList2.default(3);
  nodes.setData(data.map(function (_ref) {
  ...
  nodes.add({
    features: [Math.round(Math.random() * 10), Math.round(Math.random() * 2000)],
    type: false
  });

  nodes.determineUnknown();
  nodes.draw("canvas", "type");
